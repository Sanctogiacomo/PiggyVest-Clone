  ...
  <div class="box">
    ...
    <div class="d-flex mt-20 clear-right">
      <img src="https://storage.googleapis.com/piggybankservice.appspot.com/_story_pics/img6a9c68559e.jpeg" alt="Tobenna A" width="35" height="10">
        <div>
        <h6>Tobenna A</h6><p>Thanks to piggyvest I've saved enough money to start up a really large business</p></div></div></div><div class="box"><small>Wednesday, 5th of October 2022 by 03:08 AM</small><div class="d-flex mt-20 clear-right"><img src="https://storage.googleapis.com/piggybankservice.appspot.com/_story_pics/img2a4bd14305.jpeg" alt="Micheal F" width="35" height="10"><div>
    ...
    <div class="box">
      ...
      <div class="d-flex mt-20 clear-right">
      <img src="https://storage.googleapis.com/piggybankservice.appspot.com/_story_pics/img907630da2b.jpeg" alt="Joseph A" width="35" height="10"><div><h6>Joseph A</h6><p>Piggvest has helped me with buying my new iPhone and it is the most reliable app.</p></div></div></div><div class="box"><small>Thursday, 6th of October 2022 by 11:42 AM</small><div class="d-flex mt-20 clear-right"><img src="https://storage.googleapis.com/piggybankservice.appspot.com/_story_pics/img6a9c68559e.jpeg" alt="Tobenna A" width="35" height="10">
      <div><h6>Tobenna A</h6>
      ...
      <p>I just joined tho and I believe piggyVest won't disappoint me 😊❤️</p></div></div></div>
      ...
      <div class="d-flex mt-20 clear-right"><img src="https://storage.googleapis.com/piggybankservice.appspot.com/_story_pics/ava8c9e0a401a.jpg" alt="Oluwadamilola A" width="35" height="10"><div>
        <h6>Oluwadamilola A</h6><p>PiggyVest was introduced to me some years back and I have been able to save multiple millions over the years. I look forward to more from Piggyvest.</p></div></div></div>
        <div class="box"><small>Saturday, 24th of September 2022 by 19:58 PM</small><div class="d-flex mt-20 clear-right"><img src="https://storage.googleapis.com/piggybankservice.appspot.com/_story_pics/img907630da2b.jpeg" alt="Joseph A" width="35" height="10"><div>
          <h6>Joseph A</h6>
          <p>Piggvest has helped me with buying my new iPhone and it is the most reliable app.</p></div></div></div></div>
  </div> */}
</div>
