...
<div class="box">
  ...
  <div className="testimonial-aside">
    <div className="testimonial-aside-text">
    <h4>4 Million + customers</h4>
    <p id='testimonial-aside-p'>Since launching in 2016,
     over 4,000,000 people have used PiggyVest to manage their money better, avoid over-spending and be more accountable.</p>
    </div>
